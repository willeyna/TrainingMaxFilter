    ...
    for epoch in range(n_epochs):
        ...
        if epoch == (n_epochs-1):
            ...
            with torch.no_grad():
                ...
                fX_test = max_filter(norm_templates, X_test_orbits)
                if finite:
...
plt.title("Trained Max Filter(X) Model Test Error")
plt.xlabel("Epoch")
...
# np.save('./templates.npy', all_trained_templates[-1])
